...
# 路径到你的JSON文件的文件夹
# directory_path_1 = './data_for_LLM/LIAR-RAW/train.json'
# directory_path_2 = './data_for_LLM/RAWFC/train.json'
directory_path_1 = './data_for_LLM/LIAR-RAW/val.json'
directory_path_2 = './data_for_LLM/RAWFC/val.json'

# 输出文件夹
output_folder = './data_for_LLM'
